...
const ApexChartComprobantes = ({ comprobantes, total }) => {
  ...
  const series = [
    {
      name: "Total del comprobante cargado",
  ...
  return (
    <div className="bg-white py-10 px-10 border border-blue-500">
      <div>
        <p className="font-bold text-blue-500">Grafico de comprobantes</p>
      </div>
      <div id="chart">
        <ReactApexChart
      ...
      <div className="flex">
        <p className="font-bold text-white-500 bg-blue-600 py-1 px-3 text-white">
